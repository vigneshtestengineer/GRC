...
MODULE_NAME = "PTAX Statutory Mapping"

@pytest.mark.e2e
def test_ptax_statutory_mapping(driver):
    # """Login → CGM Executive → Statutory Master(s) → Statutory Mapping → PTAX Statutory Mapping.
    ...
    #   4. Click Add, select State & Unit, enable PTAX Statutory Mapping, configure settings, save
    # """
    ...
    page = PTAXStatutoryMapping(driver)
    page.add_ptax_statutory_mapping()
    print("✓ PTAX Statutory Mapping completed successfully")